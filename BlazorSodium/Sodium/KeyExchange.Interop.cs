...
namespace BlazorSodium.Sodium
{
   public static partial class KeyExchange
   {
      ...
      internal static partial JSObject Crypto_KX_Client_Session_Keys_Interop(byte[] clientPublicKey, byte[] clientSecretKey, byte[] serverPublicKey);
      ...
      internal static partial JSObject Crypto_KX_Server_Session_Keys_Interop(byte[] serverPublicKey, byte[] serverSecretKey, byte[] clientPublicKey);
      ...
      internal static partial JSObject Crypto_KX_KeyPair_Interop();
      ...
      internal static partial JSObject Crypto_KX_Seed_KeyPair_Interop(byte[] seed);
   }
}
