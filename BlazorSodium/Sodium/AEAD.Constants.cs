namespace BlazorSodium.Sodium
{
   public static partial class AEAD
   {
      ...
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_chacha20poly1305_ABYTES");
      }

      public static uint CHACHA20POLY1305_IETF_A_BYTES
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_chacha20poly1305_IETF_ABYTES");
      }

      public static uint CHACHA20POLY1305_IETF_KEY_BYTES
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_chacha20poly1305_IETF_KEYBYTES");
      }
      ...
      */
      ...
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_chacha20poly1305_IETF_NPUBBYTES");
      }

      public static uint CHACHA20POLY1305_IETF_NSEC_BYTES
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_chacha20poly1305_IETF_NSECBYTES");
      }

      public static uint CHACHA20POLY1305_KEY_BYTES
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_chacha20poly1305_KEYBYTES");
      }
      ...
      */
      ...
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_chacha20poly1305_NPUBBYTES");
      }

      public static uint CHACHA20POLY1305_NSEC_BYTES
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_chacha20poly1305_NSECBYTES");
      }

      public static uint XCHACHA20POLY1305_IETF_A_BYTES
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_xchacha20poly1305_IETF_ABYTES");
      }

      public static uint XCHACHA20POLY1305_IETF_KEY_BYTES
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_xchacha20poly1305_IETF_KEYBYTES");
      }
      ...
      */
      ...
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_xchacha20poly1305_IETF_NPUBBYTES");
      }

      public static uint XCHACHA20POLY1305_IETF_NSEC_BYTES
      {
         get => (uint)Sodium.GetConstantNumber("crypto_aead_xchacha20poly1305_IETF_NSECBYTES");
      }
   }
}
